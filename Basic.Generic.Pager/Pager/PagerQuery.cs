...
namespace Basic.Generic.Common.Pager
{
    public class PagerQuery : IPagerQuery
    {
        ...
        public IEnumerable<SortDescription> SortDescription { get; set; }

        public bool HasSortingCondition => (!String.IsNullOrEmpty(SortColumnName) && SortDescription == null) && !DefaultSort;
